...
HD_PWD='/home/danny/class/labs/lab11/hardware/webserver_firmware/webserver_firmware.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log webserver_fwm_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source webserver_fwm_wrapper.tcl -notrace
