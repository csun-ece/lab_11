...
HD_PWD='/home/danny/class/labs/lab11/hardware/webserver_firmware/webserver_firmware.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log webserver_fwm_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source webserver_fwm_wrapper.tcl
